...
public class StudentCollector {
    ...
    public static void main() {
        ...
        List<Student> top3Students = studentList.stream()
                .sorted(Comparator
                        .comparingDouble(Student::getPercentage)
                        .reversed())
                .limit(3)
        ...
        Set<String> subjects = studentList
                .stream()
        ...
        Map<String, Double> namePercentageMap = studentList
                .stream()
                .collect(Collectors
                        .toMap(Student::getName, Student::getPercentage));

        System.out.println(namePercentageMap);

        //---------------------------------------------------------------------------------------------
        LinkedList<Student> studentLinkedList = studentList
                .stream()
                .limit(3)
        ...
        Double sumOfPercentages = studentList
                .stream()
        ...
        Double averagePercentage = studentList
                .stream()
        ...
        DoubleSummaryStatistics studentStats = studentList
                .stream()
        ...
        Map<String, List<Student>> studentsGroupedBySubject = studentList
                .stream()
        ...
        Map<Boolean, List<Student>> studentspartionedByPercentage = studentList
                .stream()
        ...
        List<Student> first3Students = studentList
                .stream()
                .limit(3)
